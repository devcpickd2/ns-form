...
class Pemusnahan extends CI_Controller {
	...
	{	
		...
		// if (!empty($data['pemusnahan']->nama_lengkap_produksi) && !empty($data['pemusnahan']->tgl_update_produksi)) {
		// 	$prod_tanggal = (new DateTime($data['pemusnahan']->tgl_update_produksi ?? $data['pemusnahan']->tgl_update_produksi))
		// 	->format('d-m-Y | H:i');

		// 	$qr_produksi_text = "Diketahui secara digital oleh,\n"
		// 	. $data['pemusnahan']->nama_lengkap_produksi . "\n"
