    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb"> 
            <li class="breadcrumb-item">
                <a href="<?= isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] . '?search=' . urlencode($this->input->get('search')) : base_url('verifikasimagnet'); ?>">
                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        <?php
                                        if ($verifikasimagnet->status_produksi == 0) {
                                            echo '<span style="color: #99a3a4; font-weight: bold;">Created</span>';
                                        } elseif ($verifikasimagnet->status_produksi == 1) {
                                            echo '<span style="color: #28b463; font-weight: bold;">Checked</span>';
                                        } elseif ($verifikasimagnet->status_produksi == 2) {
                                ...
                                <tr>
                                    ...
                                    <td colspan="4"><?= !empty($verifikasimagnet->catatan_produksi) ? $verifikasimagnet->catatan_produksi : 'Tidak ada'; ?></td>
                                </tr>
                                <tr>
                                    <td>Disetujui Supervisor</td>
                                    <td colspan="4"><?php
                                    if ($verifikasimagnet->status_spv == 0) {
                                        echo '<span style="color: #99a3a4; font-weight: bold;">Created</span>';
                                    } elseif ($verifikasimagnet->status_spv == 1) {
                                        echo '<span style="color: #28b463; font-weight: bold;">Verified</span>';
                                    } elseif ($verifikasimagnet->status_spv == 2) {
                            ...
                            <tr>
                                ...
                                <td colspan="4"><?= !empty($verifikasimagnet->catatan_spv) ? $verifikasimagnet->catatan_spv : 'Tidak ada'; ?></td>
                            </tr>
                        </tbody>
                    </table>    
                </div>
