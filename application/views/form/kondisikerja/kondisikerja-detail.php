                                    ...
                                    <td><b>Shift : <?= $kondisikerja->shift;?><b></td>
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="6">
                                                    <?php
                                                    if ($kondisikerja->status_produksi == 0) {
                                                        echo '<span style="color: #99a3a4; font-weight: bold;">Created</span>';
                                                    } elseif ($kondisikerja->status_produksi == 1) {
                                                        echo '<span style="color: #28b463; font-weight: bold;">Checked</span>';
                                                    } elseif ($kondisikerja->status_produksi == 2) {
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="6"><?= !empty($kondisikerja->catatan_produksi) ? $kondisikerja->catatan_produksi : 'Tidak ada'; ?></td>
                                            </tr>
                                            <tr>
