...
<div class="card shadow mb-4">
    <div class="card-body">
        <form class="user" method="post" action="<?= base_url('sanitasiwarehouse/status/'.$sanitasiwarehouse->uuid);?>">
            ...
            <div class="row form-group">
                <div class="col-sm-6">
                    ...
                    <textarea class="form-control" name="catatan_spv" ><?= $sanitasiwarehouse->catatan_spv; ?></textarea>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <a href="<?= base_url('sanitasiwarehouse/verifikasi')?>" class="btn btn-md btn-danger">
