<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Pemeriksaan Giling Lada</h1>
    <nav aria-label="breadcrumb">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="user" method="post" action="<?= base_url('lada/tambah');?>">
                 <?php
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="suhu_produk" class="form-control <?= form_error('suhu_produk') ? 'invalid' : '' ?> " value="<?= set_value('suhu_produk'); ?>">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="hasil_giling" class="form-control <?= form_error('hasil_giling') ? 'invalid' : '' ?> " value="<?= set_value('hasil_giling'); ?>">
