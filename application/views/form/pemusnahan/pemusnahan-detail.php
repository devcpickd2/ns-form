    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb"> 
            <li class="breadcrumb-item">
                <a href="<?= isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] . '?search=' . urlencode($this->input->get('search')) : base_url('pemusnahan'); ?>">
                    <i class="fas fa-arrow-left"></i> Daftar Data Pemusnahan Barang / Produk</a>
                </li>
            </ol>
        </nav>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td colspan="4"><?= !empty($pemusnahan->catatan_spv) ? $pemusnahan->catatan_spv : 'Tidak ada'; ?></td>
                            </tr>
                        </tbody>
                    </table>    
                </div>
