    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <!-- <form action="<?= base_url('pengayakan/cetak') ?>" method="post" id="form_cetak_pdf"> -->
                        ...
                        <tbody>
                            ...
                            foreach($pengayakan as $val) {
                                ...
                                <tr>
                                    ...
                                    <td><?= date('H:i - d m Y', strtotime($val->tgl_update_prod)); ?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('pengayakan/statusprod/'.$val->uuid);?>" class="btn btn-warning btn-icon-split">
