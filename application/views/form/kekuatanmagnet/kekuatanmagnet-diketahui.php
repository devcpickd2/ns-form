    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <!-- <form action="<?= base_url('kekuatanmagnet/cetak') ?>" method="post" id="form_cetak_pdf"> -->
                        ...
                        <tbody>
                            ...
                            foreach($kekuatanmagnet as $val) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('kekuatanmagnet/statusprod/'.$val->uuid);?>" class="btn btn-warning btn-icon-split">
